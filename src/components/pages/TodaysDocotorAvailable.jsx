...
const columns = [
  ...
  {
    name: "Update Time",
    selector: (row) => <><Link to="/doctor">Update</Link></>,
    sortable: true,
  },
];

const TodaysDocotorAvailable = () => {
 ...
 const fetchDoctorList =async()=>{
  ...
  return (
    <div className="mt-4">
      <h3 className="text-start">Today's Doctors Available</h3>
      <DataTable
        columns={columns}
        data={filteredItems}
        pagination
...
export default TodaysDocotorAvailable;
